...
describe('DBClient - Schedule Methods', () => {
  ...
  describe('searchSchedules', () => {
    ...
    it('ステータスでフィルタリングできる', async () => {
      const activeSchedules = [{ id: '1', status: 'active' }];
    ...
    it('issue_idでフィルタリングできる', async () => {
      const issueSchedules = [{ id: '1', issue_id: 'issue-1', status: 'active' }];
    ...
    it('dedupe_keyでフィルタリングできる', async () => {
      const dedupeSchedules = [{ id: '1', dedupe_key: 'daily-report', status: 'active' }];
